        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 items-stretch lg:items-center">
            ...
            <div className="relative w-full lg:w-96">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 sm:py-3 bg-slate-800/50 border border-slate-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 transition-all text-sm sm:text-base"
              />
            </div>
            ...
            <div className="flex gap-2 sm:gap-3 w-full lg:w-auto">
              ...
              <select
                ...
                className="flex-1 lg:flex-initial px-3 sm:px-4 py-2.5 sm:py-3 bg-slate-800/50 border border-slate-600 rounded-xl text-white focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 cursor-pointer transition-all text-sm sm:text-base"
              >
                {categories.map((cat) => (
          ...
          <div className="mt-3 flex items-center justify-between text-xs sm:text-sm">
            <span className="text-gray-400">
              ...
              <span className="text-cyan-400 font-semibold">{mockProjects.length}</span> projects
            </span>
            {searchTerm && (
              <button
